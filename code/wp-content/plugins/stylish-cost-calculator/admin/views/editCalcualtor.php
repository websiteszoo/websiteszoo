					...
					<div class="col-2">
						<div class="scc-menu-dropdown">
							...
							<div class="scc-menu-dropdown-content scc-hidden">
								<a class="scc-font-settings-dropdown" href="#" data-bs-toggle="modal" data-bs-target="#settingsModal" onclick="sccToggleMenuDropdown( this )" >Font Settings</a>
								<hr>
								<a class="scc-calculator-settings-dropdown" href="#" data-bs-toggle="modal" data-bs-target="#settingsModal1" onclick="sccToggleMenuDropdown( this )" >Calculator Settings</a>
								<hr>
								<a class="scc-wordings-settings-dropdown" href="#" data-bs-toggle="modal" data-bs-target="#settingsModal2" onclick="sccToggleMenuDropdown( this )" >Wordings</a>
								<hr>
								<a class="scc-coupon-codes-dropdown" href="<?php echo esc_url( admin_url( 'admin.php?page=scc-coupons-management' ) ); ?>">Coupon Codes</a>
							</div>
						</div>
					</div>
				</div>
                        ...
                        foreach ( $section->subsection as $sub ) {
                            ...
                            ?>
								...
								<button class="scc_button btn-backend" onclick="addSliderElement(this)">
									...
									<button value="switchinput" class="scc_button btn-backend" onclick="addCheckboxElement(this,8)">
										<i class="scc-btn-spinner scc-d-none"></i>
									...
									<button class="scc_button btn-backend" onclick="addCustomMath(this)">
										<i class="scc-btn-spinner scc-d-none"></i>
										<i class="fas fa-calculator" style="padding-top:3px;"></i>
										<div class="btn-backend-text">Custom Math</div>
									</button>
									<button value="custom_code" class="scc_button btn-backend" onclick="addTextHtml(this)">
										<i class="scc-btn-spinner scc-d-none"></i>
										<i class="fas fa-calculator" style="padding-top:3px;"></i>
										<div class="btn-backend-text">Variable Math</div>
									</button>
									<button value="file_input" class="scc_button btn-backend" onclick="addFileUpload(this)">
										<i class="scc-btn-spinner scc-d-none"></i>
									...
									<button value="distance" class="scc_button btn-backend" >
										<i class="scc-btn-spinner scc-d-none"></i>
...
?>
	...
	function insertSubSection(idsubsection) {
		...
		subs += '                                      </button>'
		subs += '                                    <button value="switchinput" class="scc_button btn-backend" onclick="addCheckboxElement(this,8)"><i class="scc-btn-spinner scc-d-none"></i><i class="fas fa-image" style="font-size:13px;"></i>'
		subs += '                                        <div class="btn-backend-text">Image Button </div>'
		subs += '                                    </button>'
		subs += '                                      <button class="scc_button btn-backend" onclick="addCustomMath(this)"><i class="scc-btn-spinner scc-d-none"></i><i class="fas fa-calculator" style="padding-top:3px;font-size:13px;"></i>'
		subs += '                                          <div class="btn-backend-text">Custom Math</div>'
		subs += '                                      </button>'
		subs += '										<button value="custom_code" class="scc_button btn-backend" onclick="addTextHtml(this)"><i class="scc-btn-spinner scc-d-none"></i><i class="fas fa-calculator" style="padding-top:3px;font-size:13px;"></i>'
		...
		subs += '                                      </button>'
		subs += ' 										<button value="custom_code" class="scc_button btn-backend" onclick="addTextHtml(this)"><i class="scc-btn-spinner scc-d-none"></i><i class="fas fa-calendar-alt" style="padding-top:3px;font-size:13px;"></i>'
		subs += '											<div class="btn-backend-text">Date Picker</div>'
		subs += '										</button>'
		subs += '										<button value="distance" class="scc_button btn-backend" >'
		...
		subs += '										</button>'
		subs += '                                      <button value="custom_code" class="scc_button btn-backend" onclick="addTextHtml(this)"><i class="scc-btn-spinner scc-d-none"></i><i class="fas fa-code" style="padding-top:3px;font-size:13px;"></i>'
	...
	function insertSection(idsection, idsubsection) {
		...
		section += '									</button>'
		section += '									<button value="distance" class="scc_button btn-backend" >'
