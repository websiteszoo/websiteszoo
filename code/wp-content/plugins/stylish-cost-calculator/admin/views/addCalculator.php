		...
		<div class="modal-content p-3 vh-95">
			...
			<div class="modal-footer d-block">
				<div class="d-grid gap-2">
					<# if ( data.currentStep == 'Result' ) { #>
					<button class="btn scc-setup-wizard-button scc-backend-animated-button" data-max-steps="5" data-next-step={{ data.quizNextStep }} type="button">	
					{{data.actionBtnTitle}}
...
<div class="row row-cols-3 g-0 w-100">
  ...
  <# } #>
  <form class="mt-4" id="quiz-result-email-form">
  <legend>Email My Custom Setup Instructions</legend>
  <div class="mb-3">
      <div class="form-check" id="wq-optin-checkbox-wrapper">
        <input class="form-check-input" type="checkbox" onclick="handleEmailOptInForWQ(this)" id="wq_optin_for_comm">
        <label class="form-check-label ms-2" for="wq_optin_for_comm">Email me personalized setup instructions based on my setup wizard results.</label>
      </div>
    </div>
	<div id="wq_field_wrapper">
		<div class="mt-3">
			<label for="wq_your_name" class="form-label">Your Name</label>
		...
		<div class="mt-3">
			<label for="wq_your_email" class="form-label">Your Email</label>
