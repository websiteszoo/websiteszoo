...
class ajaxRequest {
    ...
    private function email_choice_suggestion_card( $content_cofig ) {
        ...
        foreach ( $content_cofig as $choice_key => $card_value ) {
            ...
            $choice_suggestion_padding_style = $loop_index === 0 ? 'font-size:0px;padding:10px 40px 0 40px;word-break:break-word;' : 'font-size:0px;padding:0px 40px;word-break:break-word;';
            $content .= '<tr>
                ...
                <table cellpadding="0" cellspacing="0" width="100%" border="0" style="background-color: #fafafa;color:#000000;font-family:Nunito,BlinkMacSystemFont,-apple-system,Arial,sans-serif;font-size:13px;line-height:22px;table-layout:auto;width:100%;border:none;">
                    <tr>
                      ...
                      <div class="mj-column-per-100 mj-outlook-group-fix" style="font-size:0px;text-align:left;direction:ltr;display:inline-block;vertical-align:top;width:100%;">
                        <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:top;" width="100%">
                          <tbody>
                            ...
                            <tr>
                              <td align="left" style="font-size:0px;padding:25px 25px 40px 25px;word-break:break-word;">
                                <div style="font-family:Nunito,BlinkMacSystemFont,-apple-system,Arial,sans-serif;font-size:16px;line-height:1;text-align:left;color:#000000;">
                                    ...
                                    <p>Here are your customized setup instructions, specially for ' . $website_name . '.
                                </div>
                              </td>
                            </tr>
                            <tr>
