 ...
 */
    ...
    $page_id = qempo_id();
    $default_sidebar_config = qempo_get_option('single_post_sidebar', 'right-sidebar'); 
    $default_left_sidebar = qempo_get_option('single_post_left_sidebar', 'default_sidebar');
    $default_right_sidebar = qempo_get_option('single_post_right_sidebar', 'default_sidebar');
